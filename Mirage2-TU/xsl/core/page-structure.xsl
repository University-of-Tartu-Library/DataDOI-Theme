                   ...
                   chromium.org/developers/how-tos/chrome-frame-getting-started -->
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            ...
                            <!-- 
                                @max : change page structure depending on whether we are at front page or not
                             -->
                                <xsl:choose>
                                    <xsl:when test="count(//dri:pageMeta/dri:trail) &lt; 2">
                                        <!-- front page -->
                                        <div class="row row-offcanvas row-offcanvas-right row-offcanvas-home">
...
<!--                                                     <xsl:call-template name="debug-meta"/>
 -->
                                                ...
                                                <div class="col-xs-6 col-sm-3 sidebar-home-offcanvas" id="sidebar-home" role="navigation">
...
<!--                                                     <xsl:call-template name="debug-meta"/>
 -->
    ...
    <!-- @max : TODO : create a single buildHeader template for both home and non-home screen -->
            ...
            <div class="navbar navbar-default navbar-static-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <!-- @max : make navbar image resoponsive -->
<!--                         <a href="{$context-path}/" class="navbar-brand hidden-xs hidden-sm">
 ...
 -->
                ...
                <!-- @max : instert-home-search -->
                <xsl:if test="count(//dri:pageMeta/dri:trail) &lt; 2">
                    <xsl:call-template name="insert-home-search"/>
                </xsl:if>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-2 col-sm-1">
                        <xsl:choose>
                            <xsl:when test="count(//dri:pageMeta/dri:trail) &lt; 2">
                                <button data-toggle="offcanvas" class="navbar-toggle navbar-toggle-home" type="button">
        ...
        <footer>
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-8">
                        <div>
                            -
                            <a href="https://utlib.ut.ee" target="_blank">University of Tartu Library</a><br/>
                            -
 ...
 -->
    ...
    <xsl:template name="addJavascript">
        ...
        <script>
            ...
            <!-- @max : JS resize main content area and welcome text -->  
            <xsl:text>          
    ...
    <xsl:template name="debug-meta">
        <!--
            count trails (gives you an idea regarding where we are)
            <h2><xsl:value-of select="count(//dri:pageMeta/dri:trail)"/></h2> 
            <xsl:if test="count(//dri:pageMeta/dri:trail) &lt; 2">
                <h2><xsl:text>Front page!</xsl:text></h2>
            </xsl:if>
        -->
        <xmp><xsl:copy-of select="/dri:document"/></xmp>
...
<!--
 ...
 -->
                    ...
                    <div id="hub-search-slogan-row" class="row">
                        <div id="hub-search-slogan-box" class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-3 col-md-6">
                            <p id="hub-search-slogan-box-p">
                                <i18n:text>xmlui.general.frontpage_welcome_message</i18n:text>
                            </p>
                        </div>
                    </div>
                            ...
                            <form id="hub-search-form" method="post" action="/discover">
                                <div class="input-group input-group-lg" id="hub-search-input">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="submit" class="btn btn-primary btn-lg"><i18n:text>xmlui.general.search</i18n:text></button>
                                    </span>
                                </div>
                            </form>
                        </div>
