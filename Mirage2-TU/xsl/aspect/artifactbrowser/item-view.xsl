...
<xsl:stylesheet
    ...
    <!-- @max: Item view main page template!    -->
...
<!-- original:
 ...
 -->
     ...
     <xsl:template match="dim:dim" mode="itemSummaryView-DIM">
        <div class="item-summary-view-metadata">
            <xsl:call-template name="itemSummaryView-DIM-title"/>
            <xsl:call-template name="itemSummaryView-DIM-authors-modified"/>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-date"/>
                    <!-- @max : move authors up and URI here-->
                    <xsl:call-template name="itemSummaryView-DIM-URI"/>
                    <!-- <xsl:call-template name="itemSummaryView-DIM-authors"/> -->
                    <xsl:if test="$ds_item_view_toggle_url != ''">
                        <xsl:call-template name="itemSummaryView-show-full"/>
                ...
                <div class="col-sm-8">
                    <xsl:call-template name="itemSummaryView-DIM-abstract"/>
                    <!-- @max : add a few custom templates -->
    ...
    <xsl:template name="itemSummaryView-DIM-abstract">
        <xsl:if test="dim:field[@element='description' and @qualifier='abstract']">
            <div class="simple-item-view-description item-page-field-wrapper table">
                <!-- @max : the word abstract should be alwasy visible -->
    ...
    <xsl:template name="itemSummaryView-DIM-type">
        <xsl:if test="dim:field[@element='type' and descendant::text()]">
            <div class="simple-item-view-date word-break item-page-field-wrapper table">
                <h5>
                    <i18n:text>xmlui.item_view.item_type</i18n:text>
                </h5>
...
<!--                 <div class="item-page-field-wrapper table word-break">
 ...
 --> 
    ...
    <xsl:template name="itemSummaryView-DIM-file-section-entry">
        ...
        <xsl:param name="title" />  <!-- Name -->
        <xsl:param name="label" />  <!-- Description -->
        <xsl:param name="size" />
        ...
        <tr>
            ...
            <td class="col-md-6">
                <xsl:value-of select="util:shortenString($label, 220, 2)"/>
            </td>
        </tr>
    </xsl:template>
